...
Source0  : https://dev-www.libreoffice.org/src/libcmis-0.6.2.tar.xz
...
%prep
%setup -q -n libcmis-0.6.2
cd %{_builddir}/libcmis-0.6.2
pushd ..
cp -a libcmis-0.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720049443
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcmis-0.6.so.6.1.1
/V3/usr/lib64/libcmis-c-0.6.so.6.0.0
/usr/lib64/libcmis-0.6.so.6
